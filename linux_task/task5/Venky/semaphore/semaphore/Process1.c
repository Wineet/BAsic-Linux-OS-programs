...
int main()
{
   ...
   */
   ...
   //<Vinit> you have used permission correctly
   if(-1 == SHM_Id)
   {
   ...
   */
   ...
   //<Vinit> shmat return Void pointer you missed type casting
...
// <Vinit> why again you are creating Shared Memory Not understood
		if(-1 == SHM_Id2)
		{
...
//<Vinit> shmat attach shared memory It is not for semaphore>
		  //printf("\np1:-Var1 = %d\np1:-Var2 = %d\np1:-Var3 = %d\n",structVar->Var1,structVar->Var2,structVar->Var3);
...
/***********************************************************************************************************************************/
   ...
   */
	...
	//<Vinit You have not initilised Semaphore but you are using it You must Init first
	//	"sem_init()">
...
void* incVar(struct var * variable)
{
  ...
  // <Vinit increase for loop to 60000 and try once In all for loop >
   for(i=0;i<5;i++)
   {
      /*
            mutex lock
