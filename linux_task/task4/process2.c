...
int main(int argc, char * argv[])
{
	...
	printf("P2>> global var 1 %ld\n",sm_ptr->global_var1);
	printf("P2>> global var 2 %ld\n",sm_ptr->global_var2);
	printf("P2>> global var 3 %ld\n",sm_ptr->global_var3);

	/*
	 * marking segment for destroy
	 * when ever last process will be detached
	 * Memory will be destroied
	 *
	 * */	
	...
	printf("Process2 detaching Memory\n");
