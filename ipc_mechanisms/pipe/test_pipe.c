...
//	ret_val=read(pipe_fd[0],read_buf,5); If read call First then program will get blocked until someone write to the pipe, in this case program will stuck forever
